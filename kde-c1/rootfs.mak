...
$(ROOTFS_DIR).base:
	...
	mkdir -p $@.tmp
	debootstrap --foreign --no-check-gpg --include=ca-certificates,ssh,vim,locales,ntpdate,usbmount,initramfs-tools,xorg-xinit,sddm,kde-full,libreoffice --arch=$(DIST_ARCH) $(DIST) $@.tmp $(DIST_URL)
